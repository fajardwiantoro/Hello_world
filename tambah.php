...
if (isset($_POST['submit'])) {
    ...
    $merek = $_POST['merek_barang']; // Nama barang dari input form
    ...
    $sql = "INSERT INTO barang(nama_barang, merek_barang, harga_barang, stok_barang) VALUES ('$nama', '$merek', '$harga', '$stok')";
...
<!-- Input untuk nama barang -->
<input type="text" id="merek_barang" name="merek_barang" required><br><br>
