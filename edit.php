...
if (isset($_POST['submit'])) {
    ...
    $merek = $_POST['merek_barang']; // Mengambil nama barang dari input form
    ...
    $sql = "UPDATE barang SET nama_barang = '$nama', merek_barang= '$merek', harga_barang = '$harga', stok_barang = '$stok' WHERE id_barang = $id";
...
<body>
    ...
    <form action="edit.php?id=<?php echo $_GET['id'] ?>" method="post">
        ...
        ?>
                ...
                <label for="merek_barang">Merek Barang:</label><br>
                <input type="text" id="merek_barang" name="merek_barang" value="<?php echo $data['merek_barang'] ?>" required><br><br>
